...
public class Simulation {
    ...
    public static String AlgorithmType = "FIFO";  // default algroithm type
    ...
    {
        if(AlgorithmType.equals("FIFO")) {myAlgorithm = new FCFS(MainQueue.get());}  // first come first served
        ...
        else if(AlgorithmType.equals("Prioridade")) {myAlgorithm = new Priority2(MainQueue.get());} // priority preemptive
